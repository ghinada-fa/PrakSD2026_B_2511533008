...
public class BubbleSortGUI_2511533008 extends JFrame {
    ...
    private void setArrayFromInput_3008() {
        ...
        for (int k_3008 = 0; k_3008 < array_3008.length; k_3008++) {
            ...
            labelArray_3008[k_3008].setOpaque(true);
            labelArray_3008[k_3008].setBackground(Color.WHITE);
    ...
    private void performStep_3008() {
        if (!sorting_3008 || j_3008 >= array_3008.length - 1) {
            sorting_3008 = false;
            stepButton_3008.setEnabled(false);
        ...
        resetHighlights_3008();
        StringBuilder stepLog_3008 = new StringBuilder();

        labelArray_3008[j_3008].setBackground(Color.CYAN);
        labelArray_3008[j_3008 + 1].setBackground(Color.CYAN);

        if (array_3008[j_3008] > array_3008[j_3008 + 1]) {
            // Swap
            int temp = array_3008[j_3008];
            array_3008[j_3008] = array_3008[j_3008 + 1];
            array_3008[j_3008 + 1] = temp;

            labelArray_3008[j_3008].setBackground(Color.RED);
            labelArray_3008[j_3008 + 1].setBackground(Color.RED);

            stepLog_3008.append("Langkah ").append(stepCount_3008).append(": Menukar elemen ke-")
                   .append(j_3008).append(" (").append(array_3008[j_3008]).append(") dengan ke-")
                   .append(j_3008 + 1).append(" (").append(array_3008[j_3008 + 1]).append(")\n");
        } else {
            stepLog_3008.append("Langkah ").append(stepCount_3008).append(": Tidak ada pertukaran antara ke-")
                   .append(j_3008).append(" dan ke-").append(j_3008 + 1).append("\n");
        }
        ...
        if (j_3008 >= array_3008.length - i_3008 - 1) {
            j_3008 = 0;
            i_3008++;
        }
    ...
    private void resetHighlights_3008() {
        if (labelArray_3008 != null) {
            for (JLabel label : labelArray_3008) {
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(() -> {
            BubbleSortGUI_2511533008 gui_3008 =
                    new BubbleSortGUI_2511533008();
